      ...
      <Card sx={{ zIndex: 1 }}>
        <CardContent sx={{ padding: theme => `${theme.spacing(12, 9, 7)} !important` }}>
          ...
          <svg id="ewlo62D5nuC1" xmlns="http://www.w3.org/2000/svg"
              width={40}
              height={45}
              viewBox="0 0 185 215" shapeRendering="geometricPrecision"
              textRendering="geometricPrecision"><defs>
                <linearGradient id="ewlo62D5nuC8-fill"
                  ...
                  gradientTransform="translate(0 0)"><stop id="ewlo62D5nuC8-fill-0" offset="0%"
                    stopColor="#1de5bc" /><stop id="ewlo62D5nuC8-fill-1" offset="100%" stopColor="#0898a5" />
